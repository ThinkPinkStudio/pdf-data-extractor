#!/usr/bin/env node
// PROBE NON-REGRESSIONE — RC PROF MED V2 sul fascicolo storico CEDAM "in vigore".
// Verifica che il motore ATTUALe (post-scanner determinista + tipi espliciti)
// NON sia sceso sotto la baseline storica (~12/28). NON modifica src/web/test.
...
const OUT = 'out/probe_nonreg.json'
