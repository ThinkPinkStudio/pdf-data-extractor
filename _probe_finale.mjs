#!/usr/bin/env node
// PROBE FINALE — RUN A/B decisivo su RC PROF MED V2 dopo tutti i fix.
// Pipeline fedele ai worker precedenti: OCR spaziale da cache out/ocr/, staged gruppi,
// perField=false, cascade=false, qwen2.5:7b-instruct, bge-m3, numCtx 24576,
// constrained JSON, precheck off, autoVerify false, archivio false.
...
const OUT = 'out/probe_finale.json'
