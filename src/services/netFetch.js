// `require('electron')` era disponibile solo nel processo main desktop; nell'app
// web (Node puro) electron NON esiste e `require` non è definito in ESM → il try
// fallisce e usiamo il fallback Chromium protetto da `typeof fetch`. Il ramo
// desktop è ormai inerte (Electron rimosso dal repo), ma la guardia non costa
// nulla e protegge eventuali esecuzioni future in contesti Electron.
let net
